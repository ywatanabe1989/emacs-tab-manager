...
;;; Author: ywatanabe
;;; Timestamp: <2025-02-12 18:46:19>
;;; File: /home/ywatanabe/.dotfiles/.emacs.d/inits/--remove-this-prefix-03-visu-070-tab-01-close.el
...
(defun my/tab-close-by-tab-name
    (tab-name)
...
(defun my/tab-close-by-tab-name-by-id
    (tab-id)
...
(provide '--remove-this-prefix-03-visu-070-tab-01-close)

(when
    (not load-file-name)
  (message "--remove-this-prefix-03-visu-070-tab-01-close.el loaded."
           (file-name-nondirectory
            (or load-file-name buffer-file-name))))