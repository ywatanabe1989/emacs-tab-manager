...
;;; Test file for: etm-buffer.el

;;; Copyright (C) 2025 Yusuke Watanabe (ywatanabe@scitex.ai)

;;; Commentary:
;; Tests for etm-buffer
...
;; Add your tests here
;; (ert-deftest test-etm-buffer-example ()
;;   "Example test."
;;   (should t))
...
;; --------------------------------------------------------------------------------
;; Start of Source Code from: /home/ywatanabe/.emacs.d/lisp/emacs-tab-manager/src/etm-buffer/etm-buffer.el
;; --------------------------------------------------------------------------------
;; ;;; -*- coding: utf-8; lexical-binding: t -*-
;; ;;; Author: ywatanabe
...
;; (require 'etm-buffer-auto-track)  ;; Automatic buffer tracking per tab
;; (require 'etm-buffer-ibuffer)     ;; Ibuffer integration with tab groups
;; 
;; (provide 'etm-buffer)
;; 
;; (when (not load-file-name)
...
;; --------------------------------------------------------------------------------
;; End of Source Code from: /home/ywatanabe/.emacs.d/lisp/emacs-tab-manager/src/etm-buffer/etm-buffer.el
;; --------------------------------------------------------------------------------

;;; test-etm-buffer.el ends here
