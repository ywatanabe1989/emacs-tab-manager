...
#+AUTHOR: ywatanabe
#+DATE: 2025-05-09 21:13:31 Created by https://github.com/ywatanabe1989/emacs-test
...
- [[file:tests/test-etm-close-utils.el::test-etm-close-and-next][test-etm-close-and-next]]
  + Error details:
    ...
    Started at:   2025-05-09 21:13:30+1000
    Finished.
    Finished at:  2025-05-09 21:13:30+1000
    ...
    F test-etm-close-and-next
        (ert-test-failed
         ((should-not
           (member current-name (mapcar (lambda ... ...) (tab-bar-tabs))))
          :form (member "tab2" ("tab2" "*ert*" "tab1")) :value
          ("tab2" "*ert*" "tab1")))
...
- [[file:tests/test-etm-close-utils.el::test-etm-close-others][test-etm-close-others]]
  + Error details:
    Selector: test-etm-close-others
    Passed:  0
    Failed:  1 (1 unexpected)
    Skipped: 0
    Total:   1/1
