...
;;; Author: 2025-01-23 09:12:40
;;; Timestamp: <2025-01-23 09:12:40>
;;; File: /home/ywatanabe/.dotfiles/.emacs.d/inits/03-visu-070-tab-00-init.el
...
(use-package tab-bar
  ...
  (custom-set-faces
   '(tab-bar ((t (:background "gray20" :foreground "white"))))
   '(tab-bar-tab ((t (:inherit tab-bar :background "dark green" :foreground "dark orange"))))
   '(tab-bar-tab-inactive ((t (:inherit tab-bar :background "gray20" :foreground "gray80")))))
  )
...
(define-key my/tab-bar-mode (kbd "n") 'my/tab-new)
